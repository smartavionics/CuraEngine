...
private:
    ...
    */
     ...
     * \param line_angle The line direction used for a bridge skin, nullptr if not set
     */
    void processTopBottom(const SliceDataStorage& storage, LayerPlan& gcode_layer, const SliceMeshStorage& mesh, const size_t extruder_nr, const PathConfigStorage::MeshPathConfigs& mesh_config, const SkinPart& skin_part, Polygons& concentric_perimeter_gaps, bool& added_something, int bridge_layer_nr = -1, const AngleDegrees* line_angle = nullptr) const;
